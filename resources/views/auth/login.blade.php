                   ...
                   <div class="row">
                    <div class="col-md-9">
                     ...
                     <label class="my-2">Email address*</label>
                          <input  type="email" name="email" class="form-control" placeholder="Enter your text here">
                   @error('email')
                          ...
                          <input type="password" name="password" id="passwordInput" class="form-control" placeholder="Enter password">
                                @error('password')
                                            <div class="text-danger" style="margin-left: 85px; font-size:12px">
                                                {{ $message }}</div>
                                        @enderror
                        <p class="text-end m-0 my-2"><a href="{{ route('forgot-password') }}" class="forget" style="   color: #FF6C2D;
            font-size: 14px;
            text-decoration: none;">Forget Password</a></p>
