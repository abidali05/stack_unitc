    ...
    <div class="container" id="team-content" style="position: absolute; top: 175px; left: 120px;">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <div id="team-add-id" class="add-team-btn rounded" style="background-color:#F4F4F4" data-bs-toggle="modal" data-bs-target="#addteamModal">
                    <div>
            ...
            @foreach ($teams as $team)
                <div class="col-lg-3 col-md-3 position-relative">
                    <div class="team-card team-container rounded" style="background-color:#F4F4F4">
                        ...
                        <div style="font-size: 16px;color:#0C5097 ; font-weight:600;">
