...
@section('content')
    ...
    <div class="container-fluid" id="project-content" style="position: absolute; top: 185px; left: 60px; width: 95%;">
        <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div style="border: 0.73px solid #0B9F2A; border-radius: 5px;">
                            <div class="row" style="padding: 5px;">
                                <div class="col-lg-8">
                                    <div>
                                        <p style="font-size: 12px; margin-bottom: 0px;color: #10AA2E;">Completed Task
                                        </p>
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-6" style="margin-left: -10px;">
                        <div style="border: 0.73px solid #FF6C1C; border-radius: 5px;">
                            <div class="row" style="padding: 5px;">
                                <div class="col-lg-8">
                                    <div>
                                        <p style="font-size: 12px; margin-bottom: 0px;color: #FF6C1C;">Task in progress
                                        </p>
                                    </div>
                                    <div>
                    ...
                    <div class="col-lg-6">
                        <div style="border: 0.73px solid #F12117; border-radius: 5px;">
                            <div class="row" style="padding: 5px;">
                                <div class="col-lg-8">
                                    <div>
                                        <p style="font-size: 12px; margin-bottom: 0px;color: #F12117;">Overdue Task</p>
                                    </div>
                                    <div>
         ...
         <div class="row">
             <div class="col-md-12 p-4 rounded d-flex align-items-center" style="background-color:#F4F4F4 ;height:225px">
        ...
        <div class="row pb-3 rounded"  style="background-color:#F4F4F4">
            <div class="col-md-5">
                      <div class="row" style="margin-top: 16px;" id="filter">
                    <div class="col-lg-2">
                        <button id="all" class="filter-btn active"
                            style="background: #0C5097; color: white; border:none; padding: 4px 25px; border-radius: 5px;">
                            <span>All</span>
                        </button>
                    </div>
                    <div class="col-lg-5">
                        <button id="upcoming" class="filter-btn"
                            style="background: white; color: black; border:none; padding: 4px 10px; border-radius: 5px;">
                            <span>Upcoming Deadlines</span>
                        </button>
                    </div>
                    <div class="col-lg-4">
                        <button id="overdue" class="filter-btn"
                            style="background: white; border-radius: 5px; border:none; padding: 5px 5px;">
               ...
               <div class="col-md-7 d-flex align-items-end justify-content-end ">
                      <div class="filter-controls d-flex align-items-end justify-content-end gap-2 ">
                    <!-- Date Range Filter -->
                    <div class="date-filters d-flex gap-2">
                        <div class="date-input d-flex align-items-end">
                            <label for="min-date" class="small fw-bold text-muted mb-1 me-2">From</label>
                            <input type="date" id="min-date" class="form-control form-control-sm">
                        </div>
                        <div class="date-input  d-flex  align-items-end">
                            <label for="max-date" class="small fw-bold text-muted mb-1 me-2">To</label>
              ...
              <div>
                    ...
                    <div class="view-toggle btn-group">
                        ...
                        <button class="btn btn-sm btn-outline-primary" onclick="showContent('content1')"
                            data-toggle="tooltip" data-placement="top" title="Show List View">
                            <i class="far fa-list-alt me-1"></i>List
                        </button>
                        <button class="btn btn-sm btn-outline-primary" onclick="showContent('content2')"
                            data-toggle="tooltip" data-placement="top" title="Show Grid View">
